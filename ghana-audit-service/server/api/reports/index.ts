...
import { defineAnalyticsCachedHandler } from '../../utils/analytics/cached'

export default defineAnalyticsCachedHandler<PaginatedResponse<AuditReport>>(
  async (event) => {
  ...
  { maxAge: 300, staleMaxAge: 600, name: 'public-reports-list' }
)
