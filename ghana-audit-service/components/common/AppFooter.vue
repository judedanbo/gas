<template>
  <footer class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white">
    ...
    <div class="py-10 lg:py-16">
      <div class="container">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] gap-10">
          <!-- About Column -->
          <div>
            <div class="flex items-center gap-3 mb-4">
              <Icon
                name="heroicons:building-library"
                class="w-8 h-8 text-primary dark:text-accent"
                aria-hidden="true"
              />
              <div>
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li>
                <NuxtLink
                  to="/about"
                  class="text-gray-600 dark:text-gray-400 no-underline hover:text-primary dark:hover:text-accent transition-colors"
              ...
              <li>
                <NuxtLink
                  to="/publications"
                  class="text-gray-600 dark:text-gray-400 no-underline hover:text-primary dark:hover:text-accent transition-colors"
                  >{{ $t('common.publications') }}</NuxtLink
                >
              </li>
              <li>
                <NuxtLink
            ...
            <ul class="space-y-3">
              <li>
                <NuxtLink
                  ...
                  class="text-gray-600 dark:text-gray-400 no-underline hover:text-primary dark:hover:text-accent transition-colors"
                  >{{ $t('nav.pressStatements') }}</NuxtLink
                >
              </li>
              <li>
                <NuxtLink
                  to="/publications/guidelines"
                  class="text-gray-600 dark:text-gray-400 no-underline hover:text-primary dark:hover:text-accent transition-colors"
                  >{{ $t('nav.guidelines') }}</NuxtLink
                >
              </li>
              <li>
                <NuxtLink
                  ...
                  class="text-gray-600 dark:text-gray-400 no-underline hover:text-primary dark:hover:text-accent transition-colors"
                  >{{ $t('nav.amisManuals') }}</NuxtLink
                >
              </li>
              <li>
                <NuxtLink
                  to="/publications/pfm-strategy"
                  class="text-gray-600 dark:text-gray-400 no-underline hover:text-primary dark:hover:text-accent transition-colors"
                  >{{ $t('nav.pfmStrategy') }}</NuxtLink
                >
              </li>
              <li>
                <NuxtLink
            ...
            <div class="space-y-4">
              <div class="flex gap-3">
                <Icon
                  ...
                  class="w-5 h-5 flex-shrink-0 text-primary dark:text-accent"
                  aria-hidden="true"
                />
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center gap-4 flex-wrap">
          ...
          <div class="flex gap-2 md:gap-4 flex-wrap">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="text-sm text-gray-600 dark:text-gray-400 no-underline px-3 py-2 min-h-[44px] flex items-center bg-gray-200 dark:bg-gray-800 rounded-md hover:bg-primary hover:text-white transition-all"
    ...
    <!-- Bottom Bar -->
    <div class="bg-white dark:bg-black/30 py-4 border-t border-gray-200 dark:border-gray-800">
      <div class="container">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div class="flex gap-6">
            <NuxtLink
              to="/privacy-policy"
              class="text-sm text-gray-500 no-underline hover:text-primary dark:hover:text-accent transition-colors"
...
<script setup lang="ts">
  ...
  const affiliations = [
    {
      name: 'AFROSAI-E',
      fullName: 'African Organisation of Supreme Audit Institutions',
      url: 'https://afrosai-e.org.za/'
    },
    {
      name: 'INTOSAI',
      fullName: 'International Organization of Supreme Audit Institutions',
      url: 'https://www.intosai.org/'
    },
    {
      name: 'ISSAI',
      fullName: 'International Standards of Supreme Audit Institutions',
      url: 'https://www.issai.org/'
    },
    { name: 'INTOSAI-IDI', fullName: 'INTOSAI Development Initiative', url: 'https://www.idi.no/' }
  ]

  const relatedLinks = [
    { name: 'Parliament of Ghana', url: 'https://www.parliament.gh/' },
    { name: 'Ministry of Finance', url: 'https://www.mofep.gov.gh/' },
    { name: 'Public Services Commission', url: 'https://www.psc.gov.gh/' },
    { name: "Controller & Accountant General's Dept", url: 'https://www.cagd.gov.gh/' }
  ]
</script>

<!-- Styles moved to global tailwind.css as .footer-heading component class -->
