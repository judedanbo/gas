<template>
  <NuxtLink
    ...
    class="block bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden transition-all hover:border-primary hover:shadow-lg group"
  >
    <article>
      ...
      <div class="p-6">
        ...
        <div v-if="event.registrationUrl && !isPast" class="mt-4">
          <span class="btn-primary btn-sm w-full justify-center">
            Register Now
          </span>
        </div>
      </div>
