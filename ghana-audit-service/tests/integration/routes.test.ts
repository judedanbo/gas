...
const staticRoutes = [
  ...
  { path: 'pages/about/management-team/index.vue', name: 'Management Team' },
  ...
  { path: 'pages/publications/press-statements/index.vue', name: 'Press Statements' },
  { path: 'pages/publications/press-statements/[slug].vue', name: 'Press Statement Detail' },
  { path: 'pages/publications/bulletins/index.vue', name: 'Bulletins' },
  { path: 'pages/publications/bulletins/[slug].vue', name: 'Bulletin Detail' },
  { path: 'pages/publications/guidelines/index.vue', name: 'Guidelines' },
  { path: 'pages/publications/guidelines/[slug].vue', name: 'Guideline Detail' },
  { path: 'pages/publications/amis-manuals/index.vue', name: 'AMIS Manuals' },
  ...
  { path: 'pages/media/events/index.vue', name: 'Events' },
  { path: 'pages/media/gallery/index.vue', name: 'Gallery' },
  { path: 'pages/media/gallery/[slug].vue', name: 'Gallery Album' },
