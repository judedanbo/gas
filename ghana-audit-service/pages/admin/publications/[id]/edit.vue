<template>
  <div>
    ...
    <div v-else-if="!currentItem" class="text-center py-12">
      ...
      <NuxtLink to="/admin/publications" class="btn btn-primary">Back to Publications</NuxtLink>
    </div>
    <template v-else>
...
<script setup lang="ts">
  ...
  // Check slug availability with debounce (excludes current publication)
  ...
  onMounted(async () => {
    ...
    if (item) {
      ...
      form.fileSize = item.fileSize || undefined
