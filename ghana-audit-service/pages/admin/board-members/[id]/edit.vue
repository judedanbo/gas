<template>
  <div>
    ...
    <div v-else-if="!currentItem" class="text-center py-12">
      ...
      <NuxtLink to="/admin/board-members" class="btn btn-primary">Back to Board Members</NuxtLink>
    </div>
    <template v-else>
      <div class="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Board Member</h1>
