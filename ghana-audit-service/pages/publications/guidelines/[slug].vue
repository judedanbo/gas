  ...
  <div>
    ...
    <div v-else-if="error" class="min-h-screen flex items-center justify-center">
      <div class="text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-2">Guideline Not Found</h1>
        <p class="text-gray-600 mb-6">The guideline you're looking for doesn't exist.</p>
        <NuxtLink to="/publications/guidelines" class="btn-primary"> Back to Guidelines </NuxtLink>
      </div>
    </div>
    ...
    <template v-else-if="publication">
      ...
      <div class="page-header">
        <div class="container">
          <UiBadge variant="secondary" size="sm" class="mb-4">Guideline</UiBadge>
      ...
      <CommonBreadcrumb
        :crumbs="[
          ...
          { label: publication.title, path: `/publications/guidelines/${publication.slug}` }
        ]"
      />
          ...
          <div class="max-w-3xl mx-auto">
            ...
            <div v-if="publication.fileUrl" class="bg-gray-50 rounded-lg p-8 text-center">
              <Icon
                ...
                aria-hidden="true"
              />
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Download Guideline</h3>
              <p class="text-gray-600 mb-6">Get the full guideline document in PDF format.</p>
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
              <NuxtLink to="/publications/guidelines" class="btn-outline">
