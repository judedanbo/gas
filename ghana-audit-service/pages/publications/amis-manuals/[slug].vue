  ...
  <div>
    ...
    <div v-else-if="error" class="min-h-screen flex items-center justify-center">
      <div class="text-center">
        ...
        <p class="text-gray-600 mb-6">The manual you're looking for doesn't exist.</p>
        <NuxtLink to="/publications/amis-manuals" class="btn-primary">
          Back to AMIS Manuals
        </NuxtLink>
      </div>
    </div>
    ...
    <template v-else-if="publication">
      ...
      <div class="page-header">
        <div class="container">
          <UiBadge variant="warning" size="sm" class="mb-4">AMIS Manual</UiBadge>
      ...
      <CommonBreadcrumb
        :crumbs="[
          ...
          { label: publication.title, path: `/publications/amis-manuals/${publication.slug}` }
        ]"
      />
        ...
        <div class="container">
          <div class="max-w-3xl mx-auto">
            ...
            <div v-if="publication.fileUrl" class="bg-gray-50 rounded-lg p-8 text-center">
              ...
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Download Manual</h3>
              <p class="text-gray-600 mb-6">Get the full AMIS manual in PDF format.</p>
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
              <NuxtLink to="/publications/amis-manuals" class="btn-outline">
